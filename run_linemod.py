...
if __name__=='__main__':
  parser = argparse.ArgumentParser()
  code_dir = os.path.dirname(os.path.realpath(__file__))
  parser.add_argument('--linemod_dir', type=str, default="/home/pjlab/code/damn_ws/repos/FoundationPose/model_free_ref_views/lm_test_all/test/000015", help="linemod root dir") # lm_test_all  lm_test
  parser.add_argument('--use_reconstructed_mesh', type=int, default=1)
  parser.add_argument('--ref_view_dir', type=str, default="/home/pjlab/code/damn_ws/repos/FoundationPose/dataset/linemod/ref_views/ob_0000015")
  parser.add_argument('--debug', type=int, default=0)
  parser.add_argument('--debug_dir', type=str, default=f'/home/pjlab/code/damn_ws/repos/FoundationPose/debug') # lm_test_all  lm_test
  opt = parser.parse_args()
  set_seed(0)
